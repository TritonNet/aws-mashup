...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Cumulus.Aws.Api*):
...
Execute unit tests
```
    cd "Cumulus.Aws.Api/test/Cumulus.Aws.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "Cumulus.Aws.Api/src/Cumulus.Aws.Api"
