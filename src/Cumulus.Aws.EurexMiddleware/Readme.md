...
```
    cd "Cumulus.Aws.EurexMiddleware"
    dotnet restore
```

Execute unit tests
```
    cd "Cumulus.Aws.EurexMiddleware/test/Cumulus.Aws.EurexMiddleware.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Cumulus.Aws.EurexMiddleware/src/Cumulus.Aws.EurexMiddleware"
