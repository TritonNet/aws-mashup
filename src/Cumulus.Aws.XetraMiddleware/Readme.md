...
```
    cd "Cumulus.Aws.XetraMiddleware"
    dotnet restore
```

Execute unit tests
```
    cd "Cumulus.Aws.XetraMiddleware/test/Cumulus.Aws.XetraMiddleware.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Cumulus.Aws.XetraMiddleware/src/Cumulus.Aws.XetraMiddleware"
