...
```
    cd "Cumulus.Aws.MaintenanceMiddleware"
    dotnet restore
```

Execute unit tests
```
    cd "Cumulus.Aws.MaintenanceMiddleware/test/Cumulus.Aws.MaintenanceMiddleware.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Cumulus.Aws.MaintenanceMiddleware/src/Cumulus.Aws.MaintenanceMiddleware"
