...
```
    cd "Cumulus.Aws.LambdaManager"
    dotnet restore
```

Execute unit tests
```
    cd "Cumulus.Aws.LambdaManager/test/Cumulus.Aws.LambdaManager.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Cumulus.Aws.LambdaManager/src/Cumulus.Aws.LambdaManager"
